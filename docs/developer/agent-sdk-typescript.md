...
Asks the user clarifying questions during execution. See [Handling the AskUserQuestion Tool](./agent-sdk-permissions.md#handling-the-askuserquestion-tool) for usage details.
