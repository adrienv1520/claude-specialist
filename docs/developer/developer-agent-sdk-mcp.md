...
In-process servers running within your application. For detailed information on creating custom tools, see the [Custom Tools guide](./developer-agent-sdk-custom-tools.md):
...
- [Custom Tools Guide](./developer-agent-sdk-custom-tools.md) - Detailed guide on creating SDK MCP servers
- [TypeScript SDK Reference](./developer-agent-sdk-typescript.md)
- [Python SDK Reference](./developer-agent-sdk-python.md)
- [SDK Permissions](./developer-agent-sdk-permissions.md)
