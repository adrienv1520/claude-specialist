...
3. **[Hooks](./agent-sdk-hooks.md)** - Fine-grained control over every tool execution with custom logic
...
- [Hooks Guide](./agent-sdk-hooks.md) - Learn how to implement hooks for fine-grained control over tool execution
