...
For single API calls without tool use, see [API Structured Outputs](./developer-build-with-claude-structured-outputs.md).
</Note>
...
The Agent SDK supports the same JSON Schema features and limitations as [API Structured Outputs](./developer-build-with-claude-structured-outputs.md#json-schema-limitations).
...
For complete details on supported features, limitations, and regex pattern support, see [JSON Schema limitations](./developer-build-with-claude-structured-outputs.md#json-schema-limitations) in the API documentation.
...
- [API Structured Outputs](./developer-build-with-claude-structured-outputs.md) - For single API calls
- [Custom tools](./developer-agent-sdk-custom-tools.md) - Define tools for your agents
- [TypeScript SDK reference](./developer-agent-sdk-typescript.md) - Full TypeScript API
- [Python SDK reference](./developer-agent-sdk-python.md) - Full Python API