...
See [strictKnownMarketplaces reference](./settings.md#strictknownmarketplaces) for complete configuration details, including all six supported source types, exact matching rules, and comparison with `extraKnownMarketplaces`.
...
* [strictKnownMarketplaces reference](./settings.md#strictknownmarketplaces) - Complete configuration reference for enterprise marketplace restrictions
