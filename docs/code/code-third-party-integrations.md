...
* Use the `claude /status` [slash command](./code-slash-commands.md). This command provides observability into any applied authentication, proxy, and URL settings.
...
* [Set up Amazon Bedrock](./code-amazon-bedrock.md) for AWS-native deployment
* [Configure Google Vertex AI](./code-google-vertex-ai.md) for GCP deployment
* [Set up Microsoft Foundry](./code-microsoft-foundry.md) for Azure deployment
* [Configure Enterprise Network](./code-network-config.md) for network requirements
* [Deploy LLM Gateway](./code-llm-gateway.md) for enterprise management
* [Settings](./code-settings.md) for configuration options and environment variables
