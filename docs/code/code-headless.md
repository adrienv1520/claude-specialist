...
For a complete list of CLI options and features, see the [CLI reference](./code-cli-reference.md) documentation.
...
* [CLI usage and controls](./code-cli-reference.md) - Complete CLI documentation
* [Common workflows](./code-common-workflows.md) - Step-by-step guides for common use cases
