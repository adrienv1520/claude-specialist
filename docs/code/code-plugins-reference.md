...
<Tip>
  For hands-on tutorials and practical usage, see [Plugins](./code-plugins.md). For plugin management across teams and communities, see [Plugin marketplaces](./code-plugin-marketplaces.md).
</Tip>
