...
<Tip>
  For complete technical specifications and schemas, see [Plugins reference](./code-plugins-reference.md). For marketplace management, see [Plugin marketplaces](./code-plugin-marketplaces.md).
</Tip>

Plugins let you extend Claude Code with custom functionality that can be shared across projects and teams. Install plugins from [marketplaces](./code-plugin-marketplaces.md) to add pre-built commands, agents, hooks, Skills, and MCP servers, or create your own to automate your workflows.
...
<Note>
  **Next steps**: Ready to add more features? Jump to [Develop more complex plugins](#develop-more-complex-plugins) to add agents, hooks, and MCP servers. For complete technical specifications of all plugin components, see [Plugins reference](./code-plugins-reference.md).
</Note>
...
For detailed marketplace management including Git repositories, local development, and team distribution, see [Plugin marketplaces](./code-plugin-marketplaces.md).
...
For complete instructions including configuration examples, marketplace setup, and rollout best practices, see [Configure team marketplaces](./code-plugin-marketplaces.md#how-to-configure-team-marketplaces).
...
Plugins can include [Agent Skills](./code-skills.md) to extend Claude's capabilities. Skills are model-invoked—Claude autonomously uses them based on the task context.
...
For complete Skill authoring guidance, see [Agent Skills](./code-skills.md).
...
<Note>
  **For multiple plugins**: Organize plugins in subdirectories like `./plugins/plugin-name` and update your marketplace.json accordingly. See [Plugin sources](./code-plugin-marketplaces.md#plugin-sources) for organization patterns.
</Note>
...
* **Create your first marketplace**: [Plugin marketplaces guide](./code-plugin-marketplaces.md)
...
* [Plugin marketplaces](./code-plugin-marketplaces.md) - Creating and managing plugin catalogs
* [Slash commands](./code-slash-commands.md) - Understanding custom commands
* [Subagents](./code-sub-agents.md) - Creating and using specialized agents
* [Agent Skills](./code-skills.md) - Extend Claude's capabilities
* [Hooks](./code-hooks.md) - Automating workflows with event handlers
* [MCP](./code-mcp.md) - Connecting to external tools and services
